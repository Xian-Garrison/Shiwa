...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        // Initialization code
        _selectedBackgroundColor = [UIColor colorWithRed:255/255.0 green:255/255.0 blue:588/255.0 alpha:1];
        _currentDateColor = [UIColor colorWithRed:198/255.0 green:218/255.0 blue:100/255.0 alpha:1.0];
